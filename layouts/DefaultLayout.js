...
function DefaultLayout(props) {
    ...
    return (
      <div className="w-full h-screen flex flex-col items-center justify-center">
        <p className="text-center text-lg">
          ...
          You have already enrolled in a course.
          <br />
        ...
        <Button
          as={Link}
          href="/"
          className=" bg-gradient-purple text-white mt-4"
          size="sm"
        >
          Go to Back to Study Panel
        </Button>
      </div>
    );
  }
  ...
  return (
    <div className={styles.main}>
      ...
      <div
        className={
          "w-full max-w-[800px] bg-white shadow-lg h-full fixed right-0 top-0 translate-x-full opacity-0 transition-all duration-250 z-50 " +
      ...
      <div
        className={
          styles.left + " " + styles.gamecontainer + " bg-white shadow-xl px-2"
        }
      >
        <Chip
          size="sm"
          className="top-3 absolute left-1/2 -translate-x-1/2 "
          color="success"
